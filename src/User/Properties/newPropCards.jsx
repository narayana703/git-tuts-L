...
export const PropertyCard=()=> {
  ...
  const getdata = async () => {
    ...
    await axios.post("/user/get_all_properties_new", formdata
      , {
        headers: { tkn: token },
      }
    ).then((res) => {
              ...
              {subData ? <>{(propData !== 0 && subData[0].sub_plan_list > propData.length) &&
                ...
                >
                  <Grid item  >
                    ...
                    <Fab variant="extended" aria-label="add" className="linkstyle" component={Link} to={"/user_dashboard/add_new_property"} sx={{ backgroundColor: "#060847", color: "#fff", "&:hover": { backgroundColor: "#060847", color: "#fff" } }}>
                      <AddIcon />
                      Add Property
                    </Fab>
                  </Grid>
                    ...
                    return (
                      ...
                      >
                        ...
                        <Typography variant="subtitle2" sx={{ ml: 1 }}>
                          Status: {i.prop_status == 0 ? "Waiting For Approval" : i.prop_status == 1 ? "Active" : "Inactive"}
                        </Typography>
                        ...
                        <Typography variant="subtitle2" sx={{ ml: 1 }}>
                          Rent/ Sale: {i.rent_sale === 1 && "Rent" || i.rent_sale===2 && "Sale"}
                        </Typography>

                        <Typography variant="subtitle2" sx={{ ml: 1 }}>
                          Property City <LocationOnSharpIcon sx={{ fontSize: 'medium' }} />: {i.city}
                        </Typography>
                        ...
                        >
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              updateFeature(i.prop_id)
                            }}
                          >
                            {i.is_featured == "1" ? "Remove Feature" : "Featured"}
                          </Button></Grid>
                          <Grid item xs={12}>
                          <Button
                            variant="contained"
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              // setUserId(i.id)
                              history(`/user_dashboard/editNewPropertyTab/${i.prop_id}`);
                            }}
                            sx={{ mr: 1, backgroundColor: "#060847", "&:hover": { backgroundColor: "#060847" } }}
                          >
                            Edit
