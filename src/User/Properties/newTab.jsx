...
import { EditNewPropertyDetails } from './editNewPropDetails'
import { NewFloorDetails } from  './newFloorDetails'
import { Container, Grid, Typography } from '@mui/material';
import useMediaQuery from '@mui/material/useMediaQuery';
import { LeftDrawer } from '../Dashboard/Leftdrawer';

export const EditNewPropertyTab=()=> {
  ...
  alignItems="flex-start">
    ...
    <Box sx={{ width: '100%', typography: 'body1' }}>
      ...
      <TabContext value={value}>
        ...
        <TabPanel value="1"><EditNewProperty /></TabPanel>
        <TabPanel value="2"><EditNewPropertyDetails /></TabPanel>
        <TabPanel value="4"><NewFloorDetails /></TabPanel>
        {/* {localStorage.getItem('userproptype') !== "Plot" && <TabPanel value="4"><NewFloorDetails /></TabPanel>} */}
      </TabContext>
    </Box>
    </Box>
    </>:<>  <Box m={2} sx={{ backgroundColor: "white", boxShadow: "5" }}>
