...
const handlestepTwo=(e)=>{
  ...
  else  if(user.role===3 && proj_highlights===""){
    setErr(13)
  ...
  else  if(user.role===3 && proj_overall_area===undefined){
    setErr(14)
  ...
  else  if(user.role===3 && selectedValue===undefined){
    setErr(14)
  ...
  else  if(user.role===3 && proj_min_area===undefined){
    setErr(15)
  ...
  else  if(user.role===3 && selectedValueMin===undefined){
    setErr(15)
  ...
  else  if(user.role===3 && proj_max_area===undefined){
    setErr(16)
  ...
  else  if(user.role===3 && selectedValueMax===undefined){
    setErr(16)
  ...
  else  if(user.role===3 && possession_status===""){
    setErr(19)
  ...
  //   });
  // }
  else  if(user.role !== 3 && item.unit_no===""){
    setErr(25)
  ...
  else  if(user.role !== 3 && (item.prop_cat !=="Farmland" && item.prop_cat !=="Plot")&& item.rooms===""){
    setErr(26)
  ...
  else  if(user.role !== 3 && (item.prop_cat === "House" || item.prop_cat === "Apartment" || item.prop_cat === "Villa") && item.bedrooms===""){
    setErr(27)
  ...
  else  if(user.role !== 3 && (item.prop_cat === "House" || item.prop_cat === "Apartment" || item.prop_cat === "Villa") && item.bathrooms===""){
    setErr(28)
  ...
  else  if(user.role !== 3 && (item.prop_cat !=="Plot" && item.prop_cat !=="Farmland") && item.garages===""){
    setErr(29)
...
const handleSubmit=(e)=>{
  ...
  formdata.append("city",city)
   ...
   if(otherApproval !==""){
    formdata.append("approved_by",`${approvals},${otherApproval}`)
   }
   else{
   ...
   formdata.append("sale_type",item.sale_type)
    ...
    axios.post("/user/add_new_property", formdata,  {
      headers: { tkn: token },
    }).then(function (res) {
console.log(res)
