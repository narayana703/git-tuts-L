    ...
    const locImageChange = async (e) => {
      ...
      const handleSubmit=async (e)=>{
        ...
        if(item.projType===""){
            ...
            setErr(11)
            setSnack({
                message: "Please Choose Project Status",
                type: 'error',
                open: true,
                direction: "center"
              });
            ...
            await axios.post("/admin/add_project", formdata, {
                headers: { tkn: tkn },
              }).then(function (res) {
...
<MenuItem value="Tirupathi">Tirupathi</MenuItem>
</TextField>
...
/>
                                ...
                                <Grid item>
                                    ...
                                    >
                                        <Button variant="contained" type="submit" sx={{m:3}}>Submit Property</Button>
                                        </Grid>
