...
let history=useNavigate()
    ...
    const getdata = async () => {
        ...
        await axios.post("/admin/get_all_admins"
            , formdata, {
            headers: { tkn: tkn },
        }
        ).then((res) => {
      ...
      const columns = [
        ...
        { field: "admin_location", headerName: "Location", width: 120 },
        { field: "admin_role", headerName: "Role", width: 90,valueGetter:(params)=>{
            if(params.row.admin_role){
                return "Admin"
            }
        } },
        {
           ...
           console.log(row.row.admin_id,"===============admin_id")
      history(`/Dashboard/edit_admin/${row.row.admin_id}`)
...

          {
            ...
            renderCell: (row) => (
              <IconButton>
                <VisibilityIcon sx={{ color: "#060847" }} onClick={() => {
               
           console.log(row.row.admin_id,"===============admin_id")
      history(`/Dashboard/view_admin/${row.row.admin_id}`)
    ...
    return (
        <div>
            <Helmet>
                ...
                <title>Admin Data| Buy or Sell or Rent Property Online</title>
