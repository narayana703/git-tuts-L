...
export const EnquirySearchHistory=()=> {
  ...
  const getdata = async () => {
    ...
    await axios.post("/admin/enquiry_history"
      , formdata, {
      headers: { tkn: tkn },
    }
    ).then((res) => {
  ...
  return (
    <div>
       <Helmet>
                ...
                <title>Enquiry History| Buy or Sell or Rent Property Online</title>
        ...
        <>
           ...
           <Grid container justifyContent="center"
              alignItems="center" mt={3}>
               <Grid item xs={12}>
                <Typography variant="h4" sx={{ color: "#060847" }}>Enquiry History</Typography>
              </Grid>
