...
export const SingleArticle=()=> {
  ...
  const getdata1 = async () => {
    ...
    await axios
      .post("/user/get_Single_articles", formdata)
      .then(function (res) {
    ...
    <Grid container justifyContent="center" alignItems="flex-start">
      ...
      <Grid item xs={10}>
        <Container
          maxWidth="lg"
        >
<Box  sx={{ backgroundColor: "white", borderRadius:4, p:2, pl:4, pr:4,mt:5 }}>
            {/* <br /> */}
            <Grid sx={{ ml: "", pt: '' }}>
            ...
            >
              ...
              <Chip label={data.article_cat_name}  color="warning" onClick={()=>handleClick(data.article_cat_name)} sx={{ backgroundColor: ""}}/>
              </Grid>{" "}
              &nbsp;&nbsp;
              <Grid sx={{ mt: 1 }}>
