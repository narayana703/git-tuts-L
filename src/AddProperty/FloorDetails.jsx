...
export const FloorDetails = () => {
  ...
  const { token, user,admin,tkn } = useContext(UserContext);
  ...
  const singlePropData = () => {
    ...
    axios
      .post("/admin/get_single_property_new", formdata
      , {
        headers: { tkn: tkn },
      }
      )
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post("/admin/edit_property_floor_plans_new", formdata, {
        headers: { tkn: tkn },
      })
      .then(function (res) {
        console.log("hiiiii");
  ...
  const deletefloor = async (e) => {
    ...
    await axios
      .post("/admin/delete_single_floor", formdata, {
        headers: { tkn: token },
      })
      .then(function (res) {
        console.log("hiiiii");
