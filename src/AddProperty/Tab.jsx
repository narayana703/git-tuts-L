...
export const EditPropertieTab=()=> {
  ...
  return (
    <div>
       <Helmet>
                ...
                <title>Edit Property| Buy or Sell or Rent Property Online</title>
  ...
  <Grid item xs={2}>
      ...
      <Grid item xs={10}>
       ...
       <Typography variant='h4' sx={{mt:5 ,color:"#060847"}}>Edit Property Details</Typography>
      ...
      <TabContext value={value}>
        ...
        <Grid item xs={12}>
          ...
          <TabList onChange={handleChange} aria-label="lab API tabs example">
            ...
            {localStorage.getItem('adminPropCatId') !== "3" &&  <Tab label="floor details" value="4" />}
          </TabList>
          </Grid>
          </Box>
          </Grid>
        ...
        {localStorage.getItem('adminPropCatId') !== "3" && <TabPanel value="4"><FloorDetails /></TabPanel>}
      </TabContext>
    </Box>
    </Box>
    </>:<>  <Box m={2} sx={{ backgroundColor: "white", boxShadow: "5" }}>
